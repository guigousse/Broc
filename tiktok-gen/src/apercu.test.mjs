...
const catalogue = [{ id: "a", nom: "A", prix: 5, rarete: "rare" }, { id: "b", nom: "B", prix: 9 }];
...
describe("construireCfg", () => {
  ...
  it("devine : 1 objet suffit, la cible est ignorée, les durées passent", () => {
    ...
    expect(d.cfg).toMatchObject({ type: "devine", nbObjets: 1, dureeCompte: 4, dureeRevele: 1.5, raretes: ["rare"] });
    expect(construireCfg({ type: "devine", objets: ["b"], musique: false }, catalogue).cfg).toMatchObject({ raretes: ["commun"], musique: false });
