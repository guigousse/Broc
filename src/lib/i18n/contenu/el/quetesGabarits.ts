...
> = {
  ...
  "beneficeJour#0": {
    titre: "Ο λογαριασμός της ημέρας",
    corps: [
      "Γεια σου,",
      "Χωρίς πολλά λόγια: {montant} κέρδος πριν από το βράδυ. Εκεί θα φανεί τι αξίζεις.",
    ],
  },
  "beneficeJour#1": {
    titre: "Απόψε τα λέμε στα ίσια",
    corps: [
      "Καλησπέρα,",
      "Βγάλε {montant} κέρδος μέχρι το τέλος της ημέρας και σε γράφω στο τεφτέρι μου.",
    ],
  },
  "chiffreJour#0": {
    titre: "Να κινηθεί, σήμερα",
    corps: [
      "Καλησπέρα,",
      "Το περιθώριο δεν με αφορά — η κίνηση με αφορά. {montant} εισπράξεις πριν το κλείσιμο.",
    ],
  },
  "chiffreJour#1": {
    titre: "Το ταμείο μιας ημέρας",
    corps: [
      "Γεια σου,",
      "Κάνε το ταμείο να τραγουδήσει πριν απόψε — {montant} εισπράξεις, ούτε λεπτό λιγότερο.",
    ],
  },
  "margeJour#0": {
    titre: "Η μπάζα της ημέρας",
    corps: [
      "Αγαπητέ συνάδελφε,",
      "Μια καλή πώληση αξίζει όσο δέκα μέτριες. {montant} περιθώριο σε ένα μόνο αντικείμενο, και πριν απόψε.",
    ],
  },
  "margeJour#1": {
    titre: "Μία και μόνη πώληση",
    corps: [
      "Καλησπέρα,",
      "Δεν με νοιάζει πόσα θα πουλήσεις σήμερα. Θέλω {montant} περιθώριο σε ΜΙΑ πώληση.",
    ],
  },
  "categorieJour#0": {
    titre: "Ο πάγκος της ημέρας",
    corps: [
      "Καλησπέρα,",
      "Σήμερα αναλαμβάνεις τον πάγκο {categorie}. Πούλα μου {nombre} και τα ξαναλέμε.",
    ],
  },
  "categorieJour#1": {
    titre: "Πριν το κλείσιμο",
    corps: [
      "Γεια σου,",
      "{nombre} κομμάτια από την κατηγορία {categorie}, πουλημένα πριν απόψε. Απλό, έτσι;",
    ],
  },
  "restauration#0": {
    titre: "Να ξαναλάμψει",
    corps: [
      "Καλησπέρα,",
      "Σιχαίνομαι τα ρημαγμένα. Πάρε ένα κομμάτι, βάλ' το στον πάγκο και φέρ' το μου σε κατάσταση{etat}.",
    ],
  },
  "restauration#1": {
    titre: "Ένα πέρασμα από τον πάγκο",
    corps: [
      "Γεια σου,",
      "Ένα κομμάτι, ένας πάγκος, λίγη υπομονή. Θα το πάρω πίσω μόλις φτιαχτεί{etat}.",
    ],
  },
  "legendaire#0": {
    titre: "Το κομμάτι μιας ζωής",
    corps: [
      "Αγαπητέ συνάδελφε,",
      "Τέτοιο συναντάς μία ή δύο φορές σε ολόκληρη καριέρα. Αν σήμερα περάσει μπροστά σου ένα θρυλικό κομμάτι, μην το αφήσεις να φύγει — θα ξέρω να σε ευγνωμονήσω.",
    ],
  },
  "legendaire#1": {
    titre: "Αν βγει, δικό σου",
    corps: [
      "Καλησπέρα,",
      "Λένε πως σήμερα βγαίνει κάπου ένα εξαιρετικό κομμάτι. Βάλε χέρι. Θα πληρώσω το τίμημα της τύχης.",
    ],
  },
};
