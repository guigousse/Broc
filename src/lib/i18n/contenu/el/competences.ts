...
function paliersThematiques(cat: CategorieObjet): OverlayCompetences["paliers"] {
  ...
  return {
    ...
    [`cat.${cat}.passion.1`]: {
      nom: `Λάτρης — ${c}`,
      description: `Οι πελάτες πληρώνουν +5% για αντικείμενα «${c}».`,
    },
    [`cat.${cat}.passion.2`]: {
      nom: `Παθιασμένος — ${c}`,
      description: `Οι πελάτες πληρώνουν +10% για αντικείμενα «${c}» (αντικαθιστά το «Λάτρης»).`,
    },
    [`cat.${cat}.passion.3`]: {
      nom: `Ξετρελαμένος — ${c}`,
      description: `Οι πελάτες πληρώνουν +20% για αντικείμενα «${c}» (αντικαθιστά το «Παθιασμένος»).`,
    },
    [`cat.${cat}.marchandage.1`]: {
      nom: `Παζαρτζής — ${c}`,
      description: `Στο ψάξιμο, η κατώτατη τιμή των πωλητών πέφτει 4 ποσοστιαίες μονάδες (της αναγραφόμενης τιμής) στα αντικείμενα «${c}».`,
    },
    [`cat.${cat}.marchandage.2`]: {
      nom: `Έμπειρος παζαρτζής — ${c}`,
      description: `Στο ψάξιμο, η κατώτατη τιμή των πωλητών πέφτει 8 ποσοστιαίες μονάδες (της αναγραφόμενης τιμής) στα αντικείμενα «${c}» (αντικαθιστά το «Παζαρτζής»).`,
    },
    [`cat.${cat}.marchandage.3`]: {
      nom: `Βασιλιάς του παζαριού — ${c}`,
      description: `Στο ψάξιμο, η κατώτατη τιμή των πωλητών πέφτει 12 ποσοστιαίες μονάδες (της αναγραφόμενης τιμής) στα αντικείμενα «${c}» (αντικαθιστά το «Έμπειρος παζαρτζής»).`,
    },
  };
}
...
function branchesThematiques(cat: CategorieObjet): OverlayCompetences["branches"] {
  return {
    ...
    [`cat.${cat}/marchandage`]: { nom: "Παζάρεμα" },
  };
}
...
export const COMPETENCES_EL: OverlayCompetences = {
  ...
  paliers: {
    ...
    "general.negociation.3": {
      nom: "Διπλωμάτης",
      description:
        "Αντί να φύγει θυμωμένος, ο πελάτης σού αποκαλύπτει την ακριβή μέγιστη τιμή του και σου δίνει μια τελευταία αντιπροσφορά — δεκτή έως το 110% αυτού του ορίου (1 φορά την ημέρα).",
    },
    "general.charisme.1": {
    ...
    "general.presentation.2": {
      ...
      description:
        "Το πορτοφόλι του πελάτη — τα χρήματα που έχει πάνω του — εμφανίζεται στην κάρτα διαπραγμάτευσης, μαζί με τις κατηγορίες που αγαπά και αυτές που αποφεύγει.",
    },
