...
export const es: DictionnaireUI = {
  ...
  duel: {
    ...
    mc_solide_regle: "Cada daño recibido se reduce en 1 (nunca por debajo de 0).",
    ...
    livretMiseEnPlace: "Dos jugadores, 20 puntos de escaparate cada uno. Un mazo de 20 cartas, una sola copia de cada una, 2 legendarias como máximo. Se roban 4 cartas; el segundo jugador roba 5 y dispone de 1 energía más en su primer turno.",
