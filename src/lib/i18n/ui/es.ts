...
export const es: DictionnaireUI = {
  ...
  bibliotheque: {
    consultationGrimoire: "— consultando el grimorio…",
    titre: "Habilidades",
    arbresAriaLabel: "Árboles de habilidades",
    niveauAbrege: "N{n}",
    niveauCaption: "Niv.",
    ptsCaption: "Pts",
    xpProgression: "{dansNiveau} / {requisNiveau} XP — faltan {manquant}",
    ...
    niveauRequisLabel: "Nivel requerido:",
    actuelNiveau: "Actual: N{n}",
    coutLabel: "Coste:",
    dispoLabel: "Disp.:",
    pointUnique: "pt",
    pointPluriel: "pts",
    verrouilleePrefixe: "⊘ Bloqueada —",
    palierPrecedentRequis: "rango anterior requerido",
    niveauRequisAvecActuel: "N{requis} requerido (tienes N{actuel})",
    pasAssezDePoints: "no hay suficientes puntos",
    acheterBouton: "Comprar · {cout} {unite}",
