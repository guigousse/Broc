...
export const fr = {
  ...
  chine: {
    ...
    tailleLabel: "Taille",
    themeLabel: "Thème",
    budgetsLabel: "Budgets moyens",
    appetitTheme: "Appétit +{pct} % sur {categorie}",
    themeUniquement: "{categorie} uniquement",
  ...
  // Classeur de cartes + album de timbres (Task 10 du chantier classeur-album).
  albums: {
    ...
    theme_celebrites: "Célébrités",
    "theme_culture-pop": "Culture pop",
  },
  duel: {
    cout: "Coût",
    attaque: "Attaque",
    ...
    // actions
    ac_degats_objetAdverse_un: "1 dégât à un objet adverse",
    ac_degats_objetAdverse: "{n} dégâts à un objet adverse",
    ac_degats_tousObjetsAdverses_un: "1 dégât à tous les objets adverses",
    ac_degats_tousObjetsAdverses: "{n} dégâts à tous les objets adverses",
    ac_degats_vitrineAdverse_un: "1 dégât à la vitrine adverse",
    ac_degats_vitrineAdverse: "{n} dégâts à la vitrine adverse",
