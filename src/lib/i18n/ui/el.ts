...
export const el: DictionnaireUI = {
  ...
  reglages: {
    ...
    notifsIndispo: "Διαθέσιμες στην εφαρμογή iOS",
  ...
  qg: {
    ...
    commandePrete: "Παραγγελία έτοιμη — {nom}",
  ...
  tutoriel: {
    ...
    coachStockageEtat:
      "Τα αστέρια δείχνουν την κατάσταση του αντικειμένου: όσο καλύτερη είναι, τόσο αξίζει περισσότερο.",
    coachStockageTheme:
      "Αυτό το μικρό σύμβολο θυμίζει το θέμα του — χρήσιμο για ταξινόμηση με μια ματιά.",
    coachStockageBouton:
    ...
    coachCompetencesArbres:
      "Ένα γενικό δέντρο, και ένα για κάθε οικογένεια αντικειμένων — θα εξειδικευτείς αργότερα.",
  ...
  chine: {
    ...
    tailleLabel: "Μέγεθος",
    themeLabel: "Θέμα",
    budgetsLabel: "Μέσοι προϋπολογισμοί",
    appetitTheme: "Όρεξη +{pct}% σε {categorie}",
    themeUniquement: "Μόνο {categorie}",
  ...
  carnet: {
    ...
    recompenseAria: "Ανταμοιβή: {argent} €, {xp} XP, {energie} ενέργεια, {jetons} Bazarcoins",
    livrer: "Παράδοση",
  ...
  raisons: {
    ...
    prestigeJeton: "+1 Bazarcoin",
    prestigeJetons: "+{n} Bazarcoins",
  ...
  albums: {
    ...
    theme_faune: "Πανίδα",
    theme_monuments: "Μνημεία",
    theme_celebrites: "Διασημότητες",
    "theme_culture-pop": "Ποπ κουλτούρα",
  },
  duel: {
    cout: "Κόστος", attaque: "Επίθεση", pv: "ΠΖ", casse: "Σπάει: {categorie}", regles: "Κανόνες",
    mc_barrage: "Φράγμα", mc_prompt: "Γρήγορο", mc_solide: "Ανθεκτικό", mc_fragile: "Εύθραυστο", mc_ruse: "Πονηρό", mc_cri: "Κραυγή: {action}",
    mc_cri_nom: "Κραυγή",
    mc_barrage_regle: "Όσο βρίσκεται στο παιχνίδι, οι αντίπαλες επιθέσεις πρέπει να το στοχεύουν.",
    mc_prompt_regle: "Μπορεί να επιτεθεί τον γύρο που παίζεται.",
    mc_solide_regle: "Κάθε ζημιά που δέχεται μειώνεται κατά 1 (ποτέ κάτω από το 0).",
    ...
    ac_degats_tousObjetsAdverses_un: "1 ζημιά σε όλα τα αντίπαλα αντικείμενα",
    ac_degats_tousObjetsAdverses: "{n} ζημιές σε όλα τα αντίπαλα αντικείμενα",
    ac_degats_vitrineAdverse_un: "1 ζημιά στη βιτρίνα του αντιπάλου",
    ac_degats_vitrineAdverse: "{n} ζημιές στη βιτρίνα του αντιπάλου",
    ac_soinVitrine: "αποκαταστήστε {n} ΠΖ στη βιτρίνα σας",
    ac_pioche_un: "τραβήξτε 1 κάρτα", ac_pioche: "τραβήξτε {n} κάρτες", ac_energie: "+{n} ενέργεια αυτόν τον γύρο",
    ac_gain_soi_attaque: "κερδίζει +{n} επίθεση", ac_gain_soi_pv: "κερδίζει +{n} ΠΖ",
    ac_gain_allies_attaque: "τα αντικείμενά σας κερδίζουν +{n} επίθεση", ac_gain_allies_pv: "τα αντικείμενά σας κερδίζουν +{n} ΠΖ",
    ac_gain_categorie_attaque: "τα αντικείμενά σας της κατηγορίας {categorie} κερδίζουν +{n} επίθεση", ac_gain_categorie_pv: "τα αντικείμενά σας της κατηγορίας {categorie} κερδίζουν +{n} ΠΖ",
    ac_retourEnMain: "επιστρέψτε ένα αντίπαλο αντικείμενο στο χέρι του ιδιοκτήτη του", ac_volMotCle: "κλέψτε τη λέξη-κλειδί ενός αντίπαλου αντικειμένου",
    et: " και ",
    livretTitre: "Κανόνες μονομαχίας",
    livretMiseEnPlace: "Δύο παίκτες, 20 πόντοι βιτρίνας ο καθένας. Τράπουλα 20 φύλλων, ένα μόνο αντίτυπο κάθε κάρτας, το πολύ 2 θρυλικές. Τραβάτε 4 κάρτες· ο δεύτερος παίκτης τραβάει 5 και έχει 1 επιπλέον ενέργεια στον πρώτο του γύρο.",
    livretTour: "Στον γύρο σας: το ανώτατο όριο ενέργειας ανεβαίνει κατά 1 (έως 5) και επαναφορτίζεται· τραβάτε 1 κάρτα (άδεια τράπουλα: 1, μετά 2, μετά 3 ζημιές…· το χέρι περιορίζεται σε 7)· παίζετε αντικείμενα πληρώνοντας το κόστος τους, το πολύ 4 στον πάγκο σας· κάθε αντικείμενο που παίχτηκε πριν από αυτόν τον γύρο μπορεί να επιτεθεί μία φορά.",
    livretAttaque: "Μια επίθεση στοχεύει τη βιτρίνα του αντιπάλου ή ένα αντίπαλο αντικείμενο. Αν υπάρχει Φράγμα απέναντι, πρέπει να το στοχεύσετε. Ενάντια σε ένα αντικείμενο, και τα δύο δέχονται την επίθεση του άλλου ταυτόχρονα. Ένα αντικείμενο στα 0 ΠΖ σπάει. Η ζημιά παραμένει.",
    livretRoue: "Κάθε κατηγορία σπάει μια άλλη: ένα αντικείμενο προκαλεί 1 επιπλέον ζημιά σε ένα αντικείμενο της κατηγορίας που κυριαρχεί, ακόμη και όταν αντεπιτίθεται. Τίποτα εναντίον της βιτρίνας.",
    livretVictoire: "Η βιτρίνα του αντιπάλου πέφτει στο 0: κερδίζετε. Και οι δύο στο μηδέν ταυτόχρονα: ισοπαλία.",
    livretMotsCles: "Λέξεις-κλειδιά",
  },
  soutien: {
    titre: "Στήριξε το Broc",
    borneBlague: "Αυτό το παιχνίδι δεν υπάρχει. Ακόμα.",
    borneSuite:
      "Ένα μόνο άτομο φτιάχνει το Broc, ανάμεσα σε δύο παζάρια. Οι κριτικές σου αποφασίζουν τη συνέχεια: άφησε τη δική σου, και η επόμενη κασέτα αυτού του μηχανήματος ίσως υπάρξει στ' αλήθεια.",
    merciTitre: "Ευχαριστώ που είσαι εδώ",
    merciCorps:
      "Το Broc το φτιάχνει ένα μόνο άτομο. Και μόνο που ψάχνεις εδώ, σημαίνει πολλά.",
    merciPartage:
      "Για να μεγαλώσει το έργο: ακολούθησέ μας στα κοινωνικά δίκτυα και μοιράσου τα ευρήματά σου.",
    merciAvis:
      "Οι κριτικές σου μετράνε πάρα πολύ! Κάθε βαθμολογία, κάθε πρόταση διαβάζεται με προσοχή και μεγαλώνει το παιχνίδι.",
