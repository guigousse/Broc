...
export const el: DictionnaireUI = {
  ...
  duel: {
    ...
    ac_gain_categorie_attaque: "τα αντικείμενά σας {categorie} κερδίζουν +{n} επίθεση", ac_gain_categorie_pv: "τα αντικείμενά σας {categorie} κερδίζουν +{n} ΠΖ",
    ...
    livretMiseEnPlace: "Δύο παίκτες, 20 πόντοι βιτρίνας ο καθένας. Τράπουλα 20 φύλλων, ένα μόνο αντίτυπο κάθε κάρτας, το πολύ 2 θρυλικές. Τραβάτε 4 κάρτες· ο δεύτερος παίκτης τραβάει 5.",
    livretTour: "Στον γύρο σας: το ανώτατο όριο ενέργειας ανεβαίνει κατά 1 (έως 5) και επαναφορτίζεται· τραβάτε 1 κάρτα (άδεια τράπουλα: 1, μετά 2, μετά 3 ζημιά…· το χέρι περιορίζεται σε 7)· παίζετε αντικείμενα πληρώνοντας το κόστος τους, το πολύ 4 στον πάγκο σας· κάθε αντικείμενο που παίχτηκε πριν από αυτόν τον γύρο μπορεί να επιτεθεί μία φορά.",
