...
export const el: DictionnaireUI = {
  ...
  soutien: {
    ...
    merciCorps:
      "Το Broc το φτιάχνει ένα μόνο άτομο, σε μια γωνιά του εργαστηρίου. Και μόνο που ψάχνεις εδώ, σημαίνει πολλά.",
    merciPartage:
      "Για να μεγαλώσει το έργο: ακολούθησέ μας στα κοινωνικά δίκτυα και μοιράσου τα ωραιότερα ευρήματά σου με όσους έχεις γύρω σου.",
    merciAvis:
      "Κι αν σου κάνει κέφι, άφησε μια κριτική στο κατάστημα — κάθε πρόταση βελτίωσης διαβάζεται εκεί, μία προς μία.",
