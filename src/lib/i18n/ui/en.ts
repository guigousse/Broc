...
export const en: DictionnaireUI = {
  ...
  inventaire: {
    // — stockage —
    ouvertureStockage: "— opening the storage…",
    ...
    flashEnvoyeAtelier: "{nom} sent to the workshop.",
    ...
    envoyerAtelier: "Send to the workshop",
    ...
    flashCitation: "“{texte}”",
    travauxEnCours: "— Work in progress —",
    aucunChantier: "No work underway. The workbench is free.",
    ...
    retourCabinet: "Back to the cabinet",
    total: "Total",
    ...
    diminuerPrixVente: "Lower the sale price by 5 €",
    augmenterPrixVente: "Raise the sale price by 5 €",
