...
export const en: DictionnaireUI = {
  ...
  chrome: {
    ...
    verrouAtelier: "The Workshop opens with your first Repair skill.",
  ...
  qg: {
    ...
    gazetteModaleTitre: "The Pickers' Gazette",
  ...
  tutoriel: {
    ...
    instructions: {
      ...
      "aller-chiner": "Through the *door*, then *Pick* → *Neighborhood Yard Sale*.",
      "chine-nego-echec": "Open *Haggle* and aim for the *dotted circle*.",
      "chine-achat-direct": "Fair price: *buy it as marked*.",
      ...
      "ouvrir-colis": "Open grandfather's *parcel*, by the door.",
      "preparer-etal": "Through the door again, then *Set up stall*.",
      "coffre-trace-un": "Watch: he places the controller for you.",
      "coffre-trace-deux": "Set the carafe on its *outline*: one finger to slide, two to turn.",
      "vente-refus": "He offers too little: *walk away*.",
      "vente-directe": "He'll pay the asking price: *accept*.",
      "vente-nego": "*Haggle* over the carafe: slider inside the *circle*.",
      "niveau-celebration": "You've gained a level — enjoy it!",
      "competences-visite": "Open *Skills*, bottom bar.",
      "competences-choix": "Spend your point: *Insight* → *Soul reader*.",
  ...
  sheets: {
    ...
    nivAbrege: "Lvl. {n}",
    ficheDebloque: "Unlocked ✓",
    ficheAVenir: "Coming up",
    ...
    sectionRecompenses: "Rewards",
    sectionAVenir: "Coming up",
  ...
  chine: {
    ...
    tailleLabel: "Size",
    themeLabel: "Theme",
    budgetsLabel: "Avg. budgets",
    appetitTheme: "Appetite +{pct}% on {categorie}",
    themeUniquement: "{categorie} only",
  ...
  vente: {
    ...
    vehiculeAuMaximum: "Vehicle at maximum level",
    coffrePetit: "Small boot",
    coffreMoyen: "Medium boot",
    coffreGrand: "Large boot",
    ...
    clientInconnu: { m: "A stranger", f: "A stranger", n: "Strangers" },
    ...
    labelAdverse: { m: "Them", f: "Them", n: "Them" },
    labelJoueur: "You",
  ...
  inventaire: {
    ...
    recuperer: "Collect",
    celebrationRestaurationAria: "{nom} restored: {etat}",
  ...
  carnet: {
    ...
    sectionQuotidiennes: "Daily",
    sectionHebdomadaires: "Weekly",
  ...
  raisons: {
    ...
    pieceUniqueProtegee: "One-of-a-kind piece: it can't be sold or broken down. It belongs in the collection.",
  ...
  albums: {
    ...
    theme_monuments: "Monuments",
    theme_celebrites: "Celebrities",
    "theme_culture-pop": "Pop culture",
  },
  duel: {
    ...
    mc_solide_regle: "Every damage taken is reduced by 1 (never below 0).",
    ...
    ac_degats_objetAdverse_un: "1 damage to an enemy object",
    ac_degats_objetAdverse: "{n} damage to an enemy object",
    ac_degats_tousObjetsAdverses_un: "1 damage to all enemy objects",
    ac_degats_tousObjetsAdverses: "{n} damage to all enemy objects",
    ac_degats_vitrineAdverse_un: "1 damage to the enemy shopfront",
    ...
    livretMiseEnPlace: "Two players, 20 shopfront points each. A 20-card deck, one copy of each card, at most 2 legendaries. Draw 4 cards; the second player draws 5 and has 1 extra energy on their first turn.",
