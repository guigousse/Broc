...
export const en: DictionnaireUI = {
  ...
  vente: {
    ...
    bilanEyebrowBravo: "— bravo! stall cleared —",
    bilanEyebrowChinage: "— picking summary —",
    bilanEyebrowVente: "— day summary —",
    bilanBravoTexte: "You've sold your entire stall.",
  ...
  bibliotheque: {
    ...
    niveauRequisLabel: "Level required:",
    actuelNiveau: "Current: L{n}",
    coutLabel: "Cost:",
    dispoLabel: "Avail.:",
    pointUnique: "pt",
    pointPluriel: "pts",
    verrouilleePrefixe: "⊘ Locked —",
    palierPrecedentRequis: "previous tier required",
    niveauRequisAvecActuel: "L{requis} required (you have L{actuel})",
    pasAssezDePoints: "not enough points",
    acheterBouton: "Buy · {cout} {unite}",
